    ...
    return {
        ...
        <body>
            ...
            <div class="content">
                ...
                <p class="text">
                    Your ${ customer } waiver request with number <span class="marked">${ oldId }</span>  created on ${ createdOn }
                    has been approved. <br>The corresponding unique new number is <span class="marked new">${ id }</span> 
                </p>
                <p class="text">
                    Please coordinate with ${ team } in order to fully complete this waiver request
                </p>
                <p class="text">
