...
exports.actionReminder = ( actions ) => {
    ...
    return {
        subject : `Waivers expired actions weekly reminder`,
        html : `
        <!DOCTYPE html
        ...
        <body>
            ...
            <div class="content">
                ...
                <p class="text">
                    This is the list of expired actions related to open waivers
                </p>
                <p class="text">
                ...
                <p class="text"> 
                    You can see the Waiver by clicking in the Waiver ID
