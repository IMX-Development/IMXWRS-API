...
exports.actionReminder = () => {
    ...
    return {
        subject : `Waiver Action is expired`,
        html : `
        <!DOCTYPE html
        ...
        <body>
            ...
            <div class="content">
                ...
                <p class="text">
                    Some of your actions expired yesterday, ${ date }
                </p>
                <p class="text">
                    Please take care of these actions as soon as possible in order to fulfil correctly the Waiver.
                </p>
                <p class="text">
