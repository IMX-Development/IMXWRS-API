...
exports.weeklyReminder = () =>{
    ...
    return {
        subject : `IMXWRS pending and expired actions weekly reminder`,
        html: `
        <!DOCTYPE html
        ...
        <body>
            ...
            <div class="content">
                ...
                <p class="text">
                    You have some sign pending activities and / or expired actions.
                </p>
                <p class="text">
                    Please check these actions as soon as possible in order to fulfil the waiver.
                </p>
                <p class="text">
                    You can check these activities by clicking in the buttons below
                </p>
