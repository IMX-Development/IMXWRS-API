...
FOREIGN KEY (manager) REFERENCES users(username) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
FOREIGN KEY (originator) REFERENCES users(username) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE actions
ADD CONSTRAINT FK_responsable
FOREIGN KEY (responsable) REFERENCES users(username) ON DELETE NO ACTION ON UPDATE NO ACTION;
