...
FOREIGN KEY (lender) REFERENCES users(username) ON DELETE NO ACTION ON UPDATE CASCADE;

ALTER TABLE backups
ADD CONSTRAINT FK_backups_user
FOREIGN KEY (granted) REFERENCES users(username) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE backups
ADD CONSTRAINT PK_backups
PRIMARY KEY CLUSTERED(lender,granted);
